                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-4 gap-6">
                            {/* Location Card */}
                            <div className="bg-gradient-to-br from-crown/5 to-crown/10 rounded-3xl p-6">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-crown to-crown/80 
                                                flex items-center justify-center flex-shrink-0">
                                        <FaMapMarkerAlt className="w-6 h-6 text-white" />
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Locatie</h3>
