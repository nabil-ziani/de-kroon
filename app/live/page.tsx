                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="max-w-3xl mx-auto text-center mb-8 md:mb-16">
                            <div className="inline-flex items-center bg-crown/10 text-crown px-3 sm:px-4 py-2 rounded-lg text-sm font-medium mb-4 md:mb-6">
                        ...
                        <div className="grid md:grid-cols-3 gap-4 md:gap-8">
                                ...
                                >
                                    ...
                                    {isLive ? (
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-center text-white/90">
                                            <div className="w-16 sm:w-20 h-16 sm:h-20 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-3 sm:mb-4 
                                                        shadow-[0_0_40px_rgba(255,255,255,0.1)]">
                                                <FaPlay className="w-6 h-6 sm:w-8 sm:h-8" />
                                            </div>
                                            <h3 className="text-lg sm:text-xl font-medium mb-1 sm:mb-2">Geen live uitzending</h3>
                                            <p className="text-xs sm:text-sm opacity-80">Nog geen live uitzendingen gepland.</p>
                                        </div>
                                    )}
                                    ...
                                    <button
                                        ...
                                        className="absolute top-3 sm:top-4 right-3 sm:right-4 p-2 sm:p-3 rounded-xl bg-black/20 hover:bg-black/30 transition-colors"
                                    >
                                        {isFullscreen ? (
                                            <FaCompress className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                                        ) : (
                                            <FaExpand className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                                        )}
                                    </button>
                                </div>
                                {!isFullscreen && (
                                    <div className="p-4 sm:p-6">
                                        <div className="flex items-center justify-between mb-3 sm:mb-4">
                                            <div className="flex items-center gap-2 sm:gap-3">
                                                <span className="flex h-2.5 sm:h-3 w-2.5 sm:w-3">
                                                    {isLive ? (
                                                        <>
                                                            <span className="animate-ping absolute inline-flex h-2.5 sm:h-3 w-2.5 sm:w-3 rounded-full bg-red-400 opacity-75"></span>
                                                            <span className="relative inline-flex rounded-full h-2.5 sm:h-3 w-2.5 sm:w-3 bg-red-500"></span>
                                                        </>
                                                    ) : (
                                                        <span className="relative inline-flex rounded-full h-2.5 sm:h-3 w-2.5 sm:w-3 bg-gray-300"></span>
                                                    )}
                                                </span>
                                                <span className={`text-sm sm:text-base font-medium ${isLive ? 'text-red-500' : 'text-gray-400'}`}>
                                                    {isLive ? 'Live' : 'Offline'}
                                                </span>
                                            </div>
                                        </div>
                            ...
                            <Link href="/archief" className="group">
                                <div className="h-full rounded-3xl bg-gradient-to-br from-crown/5 to-crown/10 border border-crown/10 p-6 sm:p-8 
                                            transition-all duration-300 hover:shadow-xl hover:scale-[1.02] hover:-translate-y-1">
                                    <div className="h-full flex flex-col">
                                        <div className="flex-1">
                                            <div className="w-12 h-12 sm:w-16 sm:h-16 mb-4 sm:mb-6 rounded-2xl bg-gradient-to-br from-crown to-crown/80 
                                                        flex items-center justify-center transform transition-transform duration-300
                                                        group-hover:-rotate-6">
                                                <FaArchive className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                                            </div>
                                        ...
                                        <div className="inline-flex items-center gap-2 text-crown font-medium text-sm sm:text-base">
                                            Ga naar archief
                                            <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 transform transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
