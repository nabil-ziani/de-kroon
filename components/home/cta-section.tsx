    ...
    return (
        <section className="relative py-16 md:py-32 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 w-[102%] -ml-[1%]">
                <svg className="w-full h-16 md:h-24 -mb-px" viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 md:gap-8">
                        {/* Donatie CTA */}
                        <div className="bg-gradient-to-br from-girl to-girl/80 p-6 md:p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group">
                            <div className="flex flex-col h-full">
                                <div className="mb-6 md:mb-8">
                                    <div className="flex-shrink-0 w-16 h-16 md:w-20 md:h-20 bg-white/10 rounded-2xl flex items-center justify-center mb-6 md:mb-8 group-hover:scale-110 transition-transform duration-300">
                                        <FaRegClock className="w-8 h-8 md:w-10 md:h-10 text-white" />
                                    </div>
                                    <h3 className="text-2xl md:text-4xl font-bold text-white mb-4 md:mb-6">
                                        Steun Maandelijks
                                    </h3>
                                    <div className="space-y-3 md:space-y-4 text-base md:text-lg text-white/90 mb-6 md:mb-8">
                                        <p>Met jouw vaste steun kunnen we:</p>
                                        <ul className="list-disc list-inside space-y-1.5 md:space-y-2 ml-4">
                                            <li>Activiteiten organiseren die inspireren</li>
                                            <li>Lesmateriaal vernieuwen</li>
                                            <li>Onze leerkrachten ondersteunen</li>
                                        </ul>
                                        <p className="italic text-xs md:text-sm mt-4 md:mt-6">
                                ...
                                <div className="mt-auto">
                                    <Link
                                        href="/donatie"
                                        className="inline-flex items-center bg-white text-girl px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold hover:bg-opacity-90 uppercase tracking-wide text-sm group-hover:scale-105 transform transition-transform duration-300"
                                    >
                                        Word Steunpilaar
                                    </Link>
                                </div>
                        ...
                        {/* Vrijwilliger CTA */}
                        <div className="bg-gradient-to-br from-boy to-boy/80 p-6 md:p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 group">
                            <div className="flex flex-col h-full">
                                <div className="mb-6 md:mb-8">
                                    <div className="flex-shrink-0 w-16 h-16 md:w-20 md:h-20 bg-white/10 rounded-2xl flex items-center justify-center mb-6 md:mb-8 group-hover:scale-110 transition-transform duration-300">
                                ...
                                <div className="mt-auto">
                                    <Link
                                        href="/contact"
                                        className="inline-flex items-center bg-white text-boy px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold hover:bg-opacity-90 uppercase tracking-wide text-sm group-hover:scale-105 transform transition-transform duration-300"
                                    >
                                        Word Vrijwilliger
                                    </Link>
                                </div>
